...
<body class="bg-[url('img/A.png')] bg-center bg-cover h-[90vh] w-screen">
        ...
        <div class="h-32 bg-gradient-to-r from-rose-400 from-10% via-rose-350 to-pink-200">
            <div class="flex justify-between items-center mr-12">
                ...
                <div class="flex items-center">
                    ...
                    <a href="user">
                        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="red"
                            class="bi bi-person-circle" viewBox="0 0 16 16" style="margin-left: 20px; margin-top: 10px;">
    ...
    <!-- Title Section -->
    <h1 class="font-bold text-3xl py-2 relative top-4 left-36">INVENTARIS</h1>
