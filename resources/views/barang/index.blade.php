...
<header>
    <div class="h-32 bg-gradient-to-r from-rose-400 from-10% via-rose-350 to-pink-200 ">
       <div class="flex justify-between items-center mr-12">
        ...
        <!-- Add Data Button -->
        <a href="{{ route('barang.create') }}"><button class="w-fit text-black bg-rose-400 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-md text-sm px-5 py-2.5 me-2 mb-2 dark:bg-rose-400 dark:hover:bg-rose-500 focus:outline-none dark:focus:ring-blue-800">+ Tambah Barang</button></a>
